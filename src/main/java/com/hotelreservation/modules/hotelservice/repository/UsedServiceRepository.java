package com.hotelreservation.modules.hotelservice.repository;
...
public interface UsedServiceRepository extends JpaRepository<UsedService, String>{
    ...
    """, nativeQuery=true)
    List<UsedService> getByResRoomId(@Param("resRoomId") String resRoomId);
    ...
    """, nativeQuery=true)
    Optional<UsedService> getByResRoomIdAndSerId(@Param("resRoomId") String resRoomId,

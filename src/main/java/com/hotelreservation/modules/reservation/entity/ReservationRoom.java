...
@Entity
@Table(name = "reservationRoom", indexes = {
    @Index(name = "idx_resroom_reservation", columnList = "reservationId"),
    @Index(name = "idx_resroom_room", columnList = "roomId"),
    @Index(name = "idx_resroom_dates", columnList = "checkInTime,checkOutTime")
})

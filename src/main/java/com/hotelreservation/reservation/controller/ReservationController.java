...
import com.hotelreservation.security.RequiresStaff;

import static com.hotelreservation.reservation.dto.ReservationRequests.*;
import static com.hotelreservation.reservation.dto.ReservationResponses.*;
    ...
    public InitialReservationResponse confirmHold(@RequestHeader(value = "X-User-Id", required = false) Integer userId,
        ...
        if (userId == null) {
            ...
            if (auth != null) {
                ...
                com.hotelreservation.account.entity.User user = userRepository.findByAccount(account).orElse(null);
                if (user != null) {
                    userId = user.getId();
                }
            }

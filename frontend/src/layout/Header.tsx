...
export default function Header({ title }: HeaderProps) {
  ...
  return (
    <header className="bg-apple-canvas px-6 py-4 flex items-center justify-between border-b border-apple-divider-soft h-[60px] select-none">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="relative cursor-pointer active-scale">
          ...
          <span className="absolute -top-1.5 -right-1.5 w-[16px] h-[16px] bg-red-500 text-white rounded-full text-[10px] font-bold flex items-center justify-center">
            3
          </span>
        </div>
